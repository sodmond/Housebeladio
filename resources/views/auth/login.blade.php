        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            <div class="card o-hidden border-o shadow-lg my-5">
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block" style="background:url('https://source.unsplash.com/P1djASp78Ss/600x800'); 
                            background-position:center; background-size: cover;"></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <a href="{{url('/')}}"><img src="{{ asset('img/logo1.png') }}" style="max-width:80px;"></a>
                                    <p>&nbsp;</p>
