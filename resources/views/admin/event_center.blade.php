@extends('layouts.admin', ['title' => 'Event Center', 'activePage' => 'settings'])

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Event Center</h1>
</div>
    ...
    <div class="col-lg-8 mb-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark">{{ $newStatus ?? 'Modify Event Center' }}</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
